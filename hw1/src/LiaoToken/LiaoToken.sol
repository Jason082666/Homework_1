...
contract LiaoToken is IERC20 {
    ...
    function transferFrom(address from, address to, uint256 value) external returns (bool) {
        // TODO: please add your implementaiton here
        require(_balances[from] >= value, "LiaoToken: transfer value exceeds balance");
        require(_allowances[from][msg.sender] >= value, "LiaoToken: transfer value exceeds allowance");
